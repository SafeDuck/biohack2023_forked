    ...
    return (
      <Html lang='en' className='m-0 p-0 box-border overflow-x-hidden font-sans'>
        <Head>
          ...
          <link rel='icon' type='image/png' sizes='32x32' href='/favicon-blue.png' />
          <link rel='icon' type='image/png' sizes='16x16' href='/favicon-blue.png' />
          <link rel='manifest' href='/site.webmanifest' />
          <link rel='mask-icon' href='/safari-pinned-tab.svg' color='#5bbad5' />
          <link rel='preload' as='image' href='/logo.png' />
          <link rel='preload' as='image' href='/assets/tree-left.png' />
